---
title: Figma Context
description: '集成 Figma API，提供 Figma 布局信息'
icon: skill-icons:figma-light
date: 2025-03-08
provider: Figma
to: https://github.com/GLips/Figma-Context-MCP
badges:
  - value: GitHub
...
:pm-x{command="figma-developer-mcp --figma-api-key=<your-figma-api-key>"}
...
:pm-install{name="figma-developer-mcp --figma-api-key=<your-figma-api-key>"}
...
::field-group
  ::field{name="fileKey" type="string" required}
  The key of the Figma file to fetch
  ::
  ::field{name="depth (number, optional)" type="void"}
...
::field-group
  ::field{name="fileKey" type="string"}
  The key of the Figma file containing the node
  ::
  ::field{name="nodeId"  type="string" type="void"}
