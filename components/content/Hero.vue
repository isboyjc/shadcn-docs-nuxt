<template>
  <section class="mx-auto flex max-w-[980px] flex-col items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-20">
    <NuxtLink
      ...
      class="mb-2 inline-flex items-center rounded-lg bg-muted px-3 py-1 text-sm font-medium"
    >
    ...
    <span class="mt-2 max-w-[750px] text-center text-lg text-muted-foreground sm:text-xl">
